...
REGISTERED_DB_PATH = "./audio/audio_generate/realtime_meeting_assistant/teacher_db/teacher_db.pkl"
# 如果此文件存在，将优先使用此文件进行注册，而不是录音
# TEACHER_WAV_PATH = "realtime_meeting_assistant/teacher_audio/teacher_reg.wav"
TEACHER_WAV_PATH = "./audio/audio_generate/realtime_meeting_assistant/teacher_audio/teacher_register.wav"
